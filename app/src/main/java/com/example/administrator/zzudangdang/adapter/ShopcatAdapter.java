...
public class ShopcatAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (child != null) {
            ...
            //TODO 要用Glide替换
            Glide.with(childViewHolder.goodsImage.getContext()).load(child.getGoodsImg()).placeholder(R.drawable.cmaz).into(childViewHolder.goodsImage);
            //GLIDE 替换前 childViewHolder.goodsImage.setImageResource(R.drawable.cmaz);
